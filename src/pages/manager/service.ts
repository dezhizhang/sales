/*
 * :file description:
 * :name: /sales/src/pages/manager/service.ts
 * :author: 张德志
 * :copyright: (c) 2022, Tungee
 * :date created: 2022-11-12 21:38:54
 * :last editor: 张德志
 * :date last edited: 2023-09-10 22:43:07
 */
import request from '@/utils/request';
import SERVICE_MAP from '@/utils/service';

// /** 获取当前的用户 GET /api/currentUser */
export async function getManagerList(params: Managers.RequestType): Promise<any> {
